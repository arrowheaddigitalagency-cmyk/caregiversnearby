...
export const metadata: Metadata = {
  ...
  openGraph: {
    title:
      "Caregivers Nearby | Compassionate Care. Trusted Caregivers. Right Nearby.",
    description:
      "Premium, trusted local caregiver matching network. Helping seniors age safely in the comfort of their own homes.",
  ...
  twitter: {
    ...
    description:
      "Premium local caregiver network. Compassionate home care matching services for seniors and families.",
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
      ...
      <body
        suppressHydrationWarning
        className="min-h-full flex flex-col font-sans bg-white text-brand-navy"
      >
        <noscript>
          <iframe
