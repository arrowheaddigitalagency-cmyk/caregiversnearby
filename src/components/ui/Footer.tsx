...
export default function Footer() {
  ...
  return (
    <footer className="bg-brand-navy text-slate-300 border-t border-slate-900 py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16 items-start text-left">
          ...
          <div className="md:col-span-3">
            <h3 className="text-white font-bold text-sm tracking-wider uppercase mb-6">Quick Links</h3>
            <ul className="space-y-4 text-sm">
              <li>
                <Link href="/about" className="hover:text-white transition-colors text-slate-400 font-medium">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/#services" onClick={(e) => handleFooterLinkClick(e, "/#services")} className="hover:text-white transition-colors text-slate-400 font-medium">
                  Services
                </Link>
              </li>
              <li>
                <Link href="/contact" className="hover:text-white transition-colors text-slate-400 font-medium">
                  Contact Us
                </Link>
              </li>
            </ul>
          ...
          <div className="md:col-span-4 flex flex-col gap-5 text-sm">
            <h3 className="text-white font-bold text-sm tracking-wider uppercase mb-1">Direct Contact</h3>
            ...
            <a href="tel:+14047542651" className="flex items-center gap-3 hover:text-white transition-colors group">
              ...
              <span className="font-semibold">+1 404-754-2651</span>
            </a>
            <a href="mailto:info@caregiversnearby.com" className="flex items-center gap-3 hover:text-white transition-colors group">
              ...
              <span className="font-semibold">info@caregiversnearby.com</span>
            </a>
          </div>
        ...
        {/* Divider */}
        <div className="border-t border-slate-800/60 my-12"></div>
